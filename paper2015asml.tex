...
In addition to the rating and demographic questions, a control question was incorporated to account for satisficing in online surveys~\cite{krosnick1991response}~\cite{krosnick1996satisficing}. This question served as the first counter-measure against satisficing in the survey. It asked the participant to correctly answer a question about the robot performing a simple, and easy-to-recognize motion. 
